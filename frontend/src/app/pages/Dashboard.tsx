    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-card border border-border rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all">
          ...
          <div className="mt-5 pt-5 border-t border-border">
            <p className="text-sm text-muted-foreground">🏆 Best: <span className="font-semibold text-foreground">18 days</span></p>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <span className="font-medium text-foreground">Level 8</span>
                <span className="text-sm text-muted-foreground">560 XP to Level 9</span>
              </div>
        ...
        <div className="bg-card border border-border rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all">
          ...
          <div className="space-y-4">
            <div>
              <div className="flex items-baseline gap-2">
                <span className="text-4xl font-bold text-foreground">21.5</span>
            ...
            <div className="pt-4 border-t border-border space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-foreground">3.1h/day</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-card border border-border rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all">
          ...
          <div className="space-y-3">
            {todayTasks.map((task) => (
              <div
                key={task.id}
                className="flex items-center gap-4 p-5 rounded-xl hover:bg-secondary/50 transition-all cursor-pointer group border border-transparent hover:border-border"
              >
                {task.completed ? (
                  <CheckCircle2 className="w-6 h-6 text-[#22c55e] flex-shrink-0" />
                ) : (
                  <Circle className="w-6 h-6 text-muted-foreground flex-shrink-0 group-hover:text-[#6366f1] transition-colors" />
                )}
                <span
                  className={`flex-1 ${
        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all">
          ...
          <div className="space-y-4">
            <button className="w-full p-5 bg-gradient-to-r from-[#6366f1] to-[#a855f7] text-white rounded-xl hover:shadow-lg hover:scale-105 transition-all flex items-center justify-center gap-3 font-medium">
          ...
          <div className="mt-8 p-5 bg-gradient-to-br from-[#6366f1]/10 to-[#a855f7]/10 border border-[#6366f1]/30 rounded-xl">
            <p className="font-semibold text-foreground mb-2">💡 Tip of the Day</p>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Taking regular breaks improves retention by 25%. Use the Pomodoro technique!
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all">
          ...
          <ResponsiveContainer width="100%" height={260}>
            <BarChart data={weeklyData}>
              ...
              />
              <Bar dataKey="hours" fill="url(#barGradient)" radius={[10, 10, 0, 0]} />
              <defs>
